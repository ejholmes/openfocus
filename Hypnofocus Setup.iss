...
;
[Setup]
AppName=ASCOM Hypnofocus Focuser Driver
AppVerName=ASCOM Hypnofocus Focuser Driver 0.1
AppVersion=0.1
...
DefaultDirName="{pf}\Hypnofocus"
DefaultGroupName=Hypnofocus Driver
DisableDirPage=no
DisableProgramGroupPage=yes
OutputDir="."
OutputBaseFilename="Hypnofocus Setup"
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Focuser\Hypnofocus"
...
[Dirs]
Name: "{cf}\ASCOM\Uninstall\Focuser\Hypnofocus"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Icons]
Name: "{group}\Uninstall Hypnofocus Driver"; Filename: "{uninstallexe}"
...
[Files]
Source: "ASCOM\Hypnofocus\bin\Release\ASCOM.Hypnofocus.dll"; DestDir: "{app}"; Tasks: ascom
Source: "ASCOM\Hypnofocus\bin\Release\hypnofocus.dll"; DestDir: "{app}"; Tasks: ascom
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "README.markdown"; DestDir: "{app}"; Flags: isreadme; Tasks: ascom
; Optional source files (COM and .NET aware)
Source: "ASCOM\Hypnofocus\*"; Excludes: *.zip,*.exe,*.dll, \bin\*, \obj\*, \driver\*; DestDir: "{app}\Source\ASCOM"; Tasks: source; Flags: recursesubdirs
